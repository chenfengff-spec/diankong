...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, USART2_DE_Pin|USART4_DE_Pin|USART1_DE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(USART5_DE_GPIO_Port, USART5_DE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : USART2_DE_Pin USART4_DE_Pin USART1_DE_Pin */
  GPIO_InitStruct.Pin = USART2_DE_Pin|USART4_DE_Pin|USART1_DE_Pin;
  ...
  /*Configure GPIO pin : USART5_DE_Pin */
  GPIO_InitStruct.Pin = USART5_DE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(USART5_DE_GPIO_Port, &GPIO_InitStruct);
