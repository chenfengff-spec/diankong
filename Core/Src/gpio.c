...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, USART2_DE_Pin|USART4_DE_Pin|USARTI_DE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : USART2_DE_Pin USART4_DE_Pin USARTI_DE_Pin */
  GPIO_InitStruct.Pin = USART2_DE_Pin|USART4_DE_Pin|USARTI_DE_Pin;
